...
def get_career_roadmap(user_input):
    ...
    **Output Format (JSON):**
    {{
        ...
        "recommended_courses": [
            {{"title": "Course 1", "platform": "Udemy", "url": "https://udemy.com/..."}},
            {{"title": "Course 2", "platform": "Coursera", "url": "https://coursera.org/..."}}
        ],
        "hours_per_week": 10,
        "roadmap": [
            {{"week": 1, "task": "Complete Course 1"}},
            {{"week": 2, "task": "Build a small project"}},
            {{"week": 3, "task": "Complete Course 2"}}
        ]
    }}
...
if st.button("Generate My Roadmap"):
    ...
    if roadmap:
        ...
        st.json(roadmap)  # Display formatted JSON output
    else:
